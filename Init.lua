...
local DEFAULT_COLOR = CreateColor(0.5, 0.5, 0.5, 1)
AddOn.DEFAULT_COLOR = DEFAULT_COLOR

local DEFAULT_TEXTURE = "Interface\\WorldMap\\QuestionMark_Gold_64Grey"
AddOn.DEFAULT_TEXTURE = DEFAULT_TEXTURE
local DEFAULT_TEXTURE_STRING = "|TInterface\\WorldMap\\QuestionMark_Gold_64Grey:0|t"
AddOn.DEFAULT_TEXTURE_STRING = DEFAULT_TEXTURE_STRING
local DEFAULT_TEX_COORDS = {0, 1, 0, 1}
AddOn.DEFAULT_TEX_COORDS = DEFAULT_TEX_COORDS
